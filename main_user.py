...
B_del=Button(tk, text="Удалить", command=lambda: del_data(tree, log_file, connection, cursor), state=DISABLED)
B_edit=Button(tk, text="Изменить", command=lambda: edit_data(tree,log_file, E_name, E_age, E_city, L_id, B_del, B_edit, B_Enter, connection, cursor), state=DISABLED)
